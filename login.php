                    ...
                    <div class="card">
                        <div class="card-header text-center">
                            <h5 class="card-title fw-bold">
                                ...
                                <span class="lang-de">Anmeldung</span>
                            </h5>
                        </div>
                        <div class="card-body">
