        ...
        <div class="nav-item text-nowrap">
            <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle" type="button" id="languageDropdown"
                    data-bs-toggle="dropdown" aria-expanded="false"><span class="lang-en"><img src="./assets/img/en.png" class="flag-icon" /></span><span class="lang-de"><img src="./assets/img/de.png" class="flag-icon" /></span>  Language </button>
